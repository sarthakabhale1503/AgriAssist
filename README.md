...
### **Demonstration Flow**
1. **Dual Authentication**: Role-based login system
2. **Crop Management**: Real-time crop addition with image upload
3. **AI Assistant**: Agricultural guidance via AgriBot
4. **Market Intelligence**: Live mandi price analysis
5. **Vendor Marketplace**: Browse and discover crops
6. **Communication**: Cross-role messaging and contact
7. **Live Updates**: Real-time synchronization across users
